...
from heatmap_table_format import heatmap_table_format, tooltip_angles
        ...
        if tab == 'tab-1':
            ...
            return html.Div([
                ...
                dash_table.DataTable(
                    ...
                    style_data={'font-size': '18px', 'text-align':'center', 'p': {'margin-block-start': '0px', 'margin-block-end': '0px'}},
